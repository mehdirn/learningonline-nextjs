    ...
    <div className="container mx-auto ">
      ...
      <div className="flex flex-col lg:flex-row justify-center  lg:justify-between items-center gap-5 py-10 lg:py-20">
        ...
        <div className="flex flex-col gap-5 items-start">
          ...
          <p className="leading-[3.5rem] sm:text-lg md:text-2xl lg:text-xvl">
            هیچ راهی وجود ندارد که بتوانم همان پیشرفت را در یادگیری اسپانیایی داشته باشم
            بدون استفاده از Lingua بهترین بخش این است که در حال حاضر یادگیری اسپانیایی به یکی از بزرگترین سرگرمی های من تبدیل شده است.
          </p>
        </div>
      </div>
    </div>
