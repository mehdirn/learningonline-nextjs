...
const Cta = () => {
  return (
    <div className='container mx-auto flex flex-col gap-5 items-center justify-center py-20'>
            <p className=' text-xl md:text-2xl lg:text-4xl font-medium text-center'>امروز یک درس آزمایشی رایگان دریافت کنید</p>
            <p className='text-base sm:text-lg lg:text-2xl font-medium text-center'>تحقق رویاهای زبانی خود را با مدرسه ما شروع کنید</p>
